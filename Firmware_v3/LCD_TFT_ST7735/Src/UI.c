...
static void DrawMainBase(void)
{
    ...
    ST7735_WriteString(0, 20, "U", UI_FONT_BIG, ST7735_CYAN, ST7735_BLACK);
    ST7735_WriteString(0, 50, "I", UI_FONT_BIG, ST7735_CYAN, ST7735_BLACK);
    ST7735_WriteString(0, 80, "P", UI_FONT_BIG, ST7735_YELLOW, ST7735_BLACK);

    ST7735_WriteString(103, 20, "IN",  UI_FONT_SMALL, ST7735_BLUE, ST7735_BLACK);
		ST7735_WriteString(103, 34, "TMP", UI_FONT_SMALL, ST7735_MAGENTA, ST7735_BLACK);
		ST7735_WriteString(103, 48, "SET", UI_FONT_SMALL, ST7735_CYAN, ST7735_BLACK);
		ST7735_WriteString(103, 62, "LIM", UI_FONT_SMALL, ST7735_CYAN, ST7735_BLACK);
		ST7735_WriteString(103, 76, "MEM", UI_FONT_SMALL, ST7735_MAGENTA, ST7735_BLACK);
		ST7735_WriteString(103, 90, "OUT", UI_FONT_SMALL, ST7735_WHITE, ST7735_BLACK);
...
{
    ST7735_FillRectangle(94, 46, 8, 58, ST7735_BLACK);

    if(main_field == MAIN_VSET)
        ST7735_WriteString(95, 48, ">", UI_FONT_SMALL, ST7735_YELLOW, ST7735_BLACK);
    else if(main_field == MAIN_ISET)
        ST7735_WriteString(95, 62, ">", UI_FONT_SMALL, ST7735_YELLOW, ST7735_BLACK);
    else if(main_field == MAIN_PRESET)
        ST7735_WriteString(95, 76, ">", UI_FONT_SMALL, ST7735_YELLOW, ST7735_BLACK);
    else if(main_field == MAIN_OUT)
        ST7735_WriteString(95, 90, ">", UI_FONT_SMALL, ST7735_YELLOW, ST7735_BLACK);
}
